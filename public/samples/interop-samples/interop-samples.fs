...
// Now we can start playing with them
    ...
    // var ans1 = boringFunction(1,2)
        ...
        code """ let ans1 = boring1Function $ (1,2) // prints 1 and 2 as side effects and returns "boring" """ ans1
    ...
    // Of course you can go the other way and use an f# function as a callback to js
        ...
        code """let myCallback a =
    a * 2
    let callbackResult = callback1Function $ (myCallback,10) // should be 20""" callbackResult
...
// signature. Tools exist to do this automatically from typescript...
 ...
 // F# will think it's curried, but javascript
 // won't
